...
class BatteryContoller(object):
    ...
    def _load_model(self, site_id):
        ...
        for ipolicy in range(self.num_policy):
            #model_filename = '/Users/anastasiamarkelova/PycharmProjects/pythonProject/optim-pv-battery/deploy/assets/'+f'{site_id}_{ipolicy}.h5'
            self.model[ipolicy] = load_model('/Users/anastasiamarkelova/PycharmProjects/Smart energy/DDPG/'+f'{site_id}_{ipolicy}.h5')

    def _load_norms(self, site_id):
        norm_filename = os.path.join('/Users/anastasiamarkelova/PycharmProjects/Smart energy/DDPG/', f'norm_s{site_id}.p')
